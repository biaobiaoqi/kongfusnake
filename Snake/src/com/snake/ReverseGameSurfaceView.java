...
public class ReverseGameSurfaceView extends NormalGameSurfaceView {    
//BEGIN
	//these are configurations for this game , change it by yourself
	//control
	private final static float SENSITIVE = 0.8f ;
	private final static double TOLERANCE = 0.15 ;
//END	
	
	public ReverseGameSurfaceView(Context context,
